...

{
...

    {
        ...
        Assert.assertEquals(TestSite.COUNT_TOP_LEVEL_MENU, defMenu.getMenuItemCount());
        ...
        ctxInstance.type = TestSite.indexPortletType;
...

        {
            ...
            templateItem.setValue( TestSite.indexPortletType );
...

        {
            ...
            InternalTestMenuSimple.testProcessInstance(defMenu, TestSite.indexPortletType, param);
