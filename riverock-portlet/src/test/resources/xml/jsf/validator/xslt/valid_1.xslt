...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="HeaderStart">
        ...
        <xsl:text disable-output-escaping="yes">&lt;body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0"
            bgcolor="#FFFFFF" text="#0">
        </xsl:text>
        <xsl:text disable-output-escaping="yes">&lt;div class="path"></xsl:text>
        <img>
            <xsl:attribute name="src">/images/mill-
                <xsl:value-of select="/SiteTemplate/@type"/>
                -
                <xsl:value-of select="/SiteTemplate/@language"/>
                .jpg
            </xsl:attribute>
        </img>
    ...
    <xsl:template match="FaqItem">
        ...
        <div>Q:
            <xsl:value-of select="FaqItemQuestion"/>
        </div>
        <div>A:
            <xsl:value-of select="FaqItemAnswer"/>
        </div>
    </xsl:template>
    ...
    <xsl:template match="NewsItem">
        <div class="news">
            ...
            <div class="text">
                ...
                <xsl:call-template name="nbsp-ref"/>
                <xsl:call-template name="nbsp-ref"/>
                <a href="{UrlToFullNewsItem}&amp;mill.template=default_dynamic" class="newsNext">
    ...
    <xsl:template match="JobItem">
        <tr>
            ...
            <td>
                <a href="{@url}&amp;mill.template=default_dynamic" class="newsNext">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <xsl:value-of select="@ageFrom"/>
                            ,
                            <xsl:value-of select="@ageTillString"/>
    ...
    <xsl:template match="PricePositionCurrent">
        <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="CurrencyItem">
        <option value="{CurrencyID}">
            ...
            1:
            <xsl:value-of select="CurrencyCurs"/>
        </option>
    </xsl:template>
