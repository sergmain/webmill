...
<f:loadBundle basename="org.riverock.portlet.resource.Webclip" var="manager"/>
...
<h:panelGrid rendered="#{!empty webclipAction.result}">
    <h:panelGroup>
        <h:panelGrid>
            <h:commandButton id="clear-result-action" action="#{webclipAction.clearResult}" value="#{manager.clear_result_button}"
                             styleClass="top-button-action"/>
            <h:outputText value="#{manager.clear_result_info}" style="font-size:10px"/>
        </h:panelGrid>
    </h:panelGroup>
