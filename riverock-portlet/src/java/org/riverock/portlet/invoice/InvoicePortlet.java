...
public class InvoicePortlet implements Portlet {
    private static Logger log = Logger.getLogger(InvoicePortlet.class);
...
//                String orderCustomString =
//                    CtxInstance.getStr("reg.send_order.1",
//                        new Object[]
//                        {
//                            ""+order.getIdOrder()
//                        }
...
//                        orderCustomString += CtxInstance.getStr("reg.send_order.shop-header",
//                            new Object[]
//                            {
//                                ""+shopOrder.getIdShop(),
//                                shopTemp.name_shop,
...
//                            orderCustomString += CtxInstance.getStr("reg.send_order.2",
//                                new String[]
//                                {
//                                    "" + (i + 1),
//                                    item.getItem(),
...
//                        orderAdminString += CtxInstance.getStr("reg.send_order.shop-header",
//                            new Object[]
//                            {
//                                ""+shopOrder.getIdShop(),
//                                shopTemp.name_shop,
...
//                            orderAdminString += CtxInstance.getStr("reg.send_order.2",
//                                new String[]
//                                {
//                                    "" + (i + 1),
//                                    item.getItem(),
...
//                            );
                ...
                String str = null;
                String args1[] = {CtxInstance.url("mill.index")};

                final String sendOrderName = "invoice.order-send-complete";
                s = bundle.getString( sendOrderName );
                if (s!=null) {
//                    str = CtxInstance.getStringManager().getStr(sendOrderName, args1);
            ...
            if (order.getAuthSession() == null) {
                ...
                String backURL = StringTools.rewriteURL( CtxInstance.url("mill.invoice") );
...
//                out.write(CtxInstance.getStr("invoice.attention"));
                out.write("<br>\n");
...
//                    out.write(CtxInstance.getStr("invoice.register"));
                    out.write("\n");
                    out.write("<a href=\"");
                    out.write(
...
//                    out.write(CtxInstance.getStringManager().getStr("button.next"));
                ...
                out.write(
                    ...
                    ServletTools.getHiddenItem(Constants.NAME_TYPE_CONTEXT_PARAM, "mill.register")+
                    addForm+
...
//                out.write(CtxInstance.getStr("invoice.login"));
                out.write("</td>\n");
...
//                out.write(CtxInstance.getStr("invoice.password"));
                out.write("</td>\r\n");
                out.write("<td class=\"pricedata\">");
...
//            out.write(CtxInstance.getStr("invoice.continue_select"));
            out.write("</a>");
            out.write("</td>\n</tr>\n</table>\n<br>");
            out.write( bundle.getString( "invoice.your_select") );
//            out.write( CtxInstance.getStr("invoice.your_select") );
...
//                    out.write(CtxInstance.getStr("invoice.name_item"));

                    out.write("</th>\n");
                    out.write("<th class=\"priceData\">");
                    out.write( bundle.getString( "invoice.ppq") );
//                    out.write(CtxInstance.getStr("invoice.ppq"));

                    out.write("</th>\n");
                    out.write("<th class=\"priceData\">");
                    out.write( bundle.getString( "invoice.quantity") );
//                    out.write(CtxInstance.getStr("invoice.quantity"));

                    out.write("</th>\n");
                    out.write("<th class=\"priceData\">");
                    out.write( bundle.getString( "invoice.total_price") );
//                    out.write(CtxInstance.getStr("invoice.total_price"));

                    out.write("</th>\n");
                    out.write("<th class=\"priceData\">");
                    out.write( bundle.getString( "invoice.currency") );
//                    out.write(CtxInstance.getStr("invoice.currency"));

                    out.write("</th>\n");
                    out.write("<th class=\"priceData\">");
                    out.write( bundle.getString( "invoice.delete_item") );
//                    out.write(CtxInstance.getStr("invoice.delete_item"));
...
//                        out.write(CtxInstance.getStr("invoice.change_qty"));
...
//                        out.write(CtxInstance.getStr("invoice.delete_button"));
...
//                    out.write(CtxInstance.getStr("invoice.total_summ"));
...
//                out.write(CtxInstance.getStr("invoice.send_button"));
