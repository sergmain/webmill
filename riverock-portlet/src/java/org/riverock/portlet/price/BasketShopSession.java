...
//	String url_redir = PortletTools.getString(renderRequest, "url", "/");
//	String url 	= tools.replaceString(url_redir, "?", "%3F");
//	url_redir 	= tools.replaceString(url_redir, "%3F", "?");
//---

            String url_redir = PortletTools.getString(renderRequest, "url", ctxInstance.ctx());
...
//	url		= tools.replaceString(url, "=", "%3D");
            ...
            String username = PortletTools.getString(renderRequest, "username").trim();
            String password1 = PortletTools.getString(renderRequest, "password1").trim();
            String password2 = PortletTools.getString(renderRequest, "password2").trim();
            ...
            String address = PortletTools.getString(renderRequest, "address");
...
//if(true) return;
            ...
            if ((auth_ != null) && (auth_.checkAccess(db_, renderRequest.getServerName())))
            {
            ...
            if (action.equals("reg_new"))
            {
                ...
                )
                {
                    ...
                    if (auth_.checkAccess(db_, renderRequest.getServerName()))
                    {
...
//out.print("url: "+url_redir);
            ...
            {
                if ((auth_ == null) ||
                    (!auth_.checkAccess(db_, renderRequest.getServerName()))
                )
