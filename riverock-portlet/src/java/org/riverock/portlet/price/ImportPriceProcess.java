...
//                            ps2.setTimestamp(9, new Timestamp( System.currentTimeMillis() ) );
        ...
        throws Exception
    {
        ...
        // Затем выбираем все помеченные для удаления элементы
...
*/
            ...
            try
            {
                // Помечаем записи, загружаемые первый раз
                ps = dbDyn.prepareStatement(
...
*/
            ...
            try
            {
                // во всех прайс-листах, которые закачиваем, устанавливаем атрибут 'Устарел'
                ps = dbDyn.prepareStatement(
...
/*
// Поле ADD_DATE устанавливается в момент занесения наименования
            try
            {
                ps = dbDyn.prepareStatement(
                    "update PRICE_LIST "+
