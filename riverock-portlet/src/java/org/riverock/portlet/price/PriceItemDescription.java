...

{
    ...
    private static PriceItemDescription backupObject = null;

    private static Object syncObject = new Object();



    public static PriceItemDescription getInstance( Long idSite )
...

        {
...

            {
...

                {
                    ...
                    backupObject = new PriceItemDescription( idSite );
...

    {
...

        {
            ...
            log.error("Exception in PriceItemDescription(...", e);
...

        {
            ...
            log.error("Error in PriceItemDescription(...", e);
