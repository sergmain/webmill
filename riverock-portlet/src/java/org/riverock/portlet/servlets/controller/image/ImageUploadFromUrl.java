...
//                    return;
...

                {
                    ...
                    out.write(
                            ...
                            "<p><a href=\"" + CtxURL.url(ctxInstance.getPortletRequest(), response, ctxInstance.page, "mill.image.index") + "\">«агрузить данные повторно</a></p><br>" +

                            "<p><a href=\"" + response.encodeURL(CtxURL.ctx()) + '?' + ctxInstance.page.getAsURL() + "\">Ќа главную страницу</a></p>"
