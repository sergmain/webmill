...

            {
...

                {
                    ...
                    out.write(
                            ...
                            "<p><a href=\"" + CtxURL.url(request, response, jspPage, "mill.image.index") + "\">«агрузить данные повторно</a></p><br>" +

                            "<p><a href=\"" + response.encodeURL(CtxURL.ctx()) + '?' + jspPage.getAsURL() + "\">Ќа главную страницу</a></p>"
