...
//                        return;
                    ...
                    String right =
                            (one.equals(PortletTools.getInt(renderRequest, "rs"))?"S":"")+
                            (one.equals(PortletTools.getInt(renderRequest, "ri"))?"I":"")+
                            (one.equals(PortletTools.getInt(renderRequest, "rd"))?"D":"")+
                            (one.equals(PortletTools.getInt(renderRequest, "ru"))?"U":"")+
                            (one.equals(PortletTools.getInt(renderRequest, "ra"))?"A":"");
                    ...
                    RsetTools.setLong(ps, 1, PortletTools.getLong(renderRequest, "id_access_group"));
                    RsetTools.setLong(ps, 2, PortletTools.getLong(renderRequest, "id_object_arm"));
                    ps.setString(3, right);
                    ps.setInt(4, PortletTools.getInt(renderRequest, "is_road", new Integer(9)).intValue() );
                    ps.setInt(5, PortletTools.getInt(renderRequest, "is_service", new Integer(9)).intValue() );
                    ps.setInt(6, PortletTools.getInt(renderRequest, "is_firm", new Integer(9)).intValue() );
