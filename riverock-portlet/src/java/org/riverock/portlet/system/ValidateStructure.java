...
/*
        ...
        schema = DatabaseManager.getDbStructure(db_, "MILLENNIUM");
...

        {
            ...
            DbTableType tableForCheckPk =
                ...
                DatabaseManager.getTableFromStructure(schema, table.getName());
...
//                    System.out.println("orig table PK "+table.getPrimaryKey()+", table for check PK "+tableForCheckPk.getPrimaryKey()+"");
...

            {
                ...
                DatabaseManager.addPrimaryKey(db_, tableForCheckPk, table.getPrimaryKey());
...
*/
        ...
        XmlTools.writeToFile(schemaResult, WebmillConfig.getWebmillDebugDir()+"schema-result-"+nameConnection+".xml" );
