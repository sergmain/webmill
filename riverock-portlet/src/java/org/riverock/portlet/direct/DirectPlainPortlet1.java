 ...
 * $Id$
 */
public final class DirectPlainPortlet1 implements Portlet {

    private final static Logger log = Logger.getLogger( DirectPlainPortlet1.class );

    public DirectPlainPortlet1(){}
    ...
    public void render1( final RenderRequest renderRequest, final RenderResponse renderResponse) throws PortletException, IOException {
