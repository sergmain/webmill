...
// Company actions
    public void deleteCompanyActionListener( ActionEvent event ) {
        ...
        iterator = holdingSessionBean.getHoldingBean().getCompanies().iterator();
...
// Delete actions
    ...
    private HoldingBean lookupHoldingBean( Long holdingId ) {
        ...
        Iterator<HoldingBean> iterator = holdingDataProvider.getHoldingBeans().iterator();
        while( iterator.hasNext() ) {
            HoldingBean holdingBean = iterator.next();
