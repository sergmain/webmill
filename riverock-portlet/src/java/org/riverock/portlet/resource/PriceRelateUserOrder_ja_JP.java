 ...
 */
public class PriceRelateUserOrder_ja_JP extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_ja_JP.class );
