 ...
 */
public class PriceRelateUserOrder_it_IT extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_it_IT.class );
