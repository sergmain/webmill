 ...
 */
public class PriceRelateUserOrder_ru_RU extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_ru_RU.class );
