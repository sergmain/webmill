 ...
 */
public class PriceRelateUserOrder_de_DE extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_de_DE.class );
