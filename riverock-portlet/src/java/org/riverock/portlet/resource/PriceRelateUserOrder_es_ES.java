 ...
 */
public class PriceRelateUserOrder_es_ES extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_es_ES.class );
