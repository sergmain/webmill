...
//                        renderRequest.getPortletSession().setAttribute( org.riverock.webmill.main.Constants.PORTLET_REQUEST_SESSION, ctxInstance );

                        if (log.isDebugEnabled()) {
                            log.debug("ctx session - "+renderRequest.getPortletSession());
