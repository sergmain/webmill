...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="TextBlock1">
		<xsl:text disable-output-escaping="yes">&lt;/td>&lt;td valign="top"></xsl:text>
		<div class="frame">
			<div class="label">‚­Ё¬ ­ЁҐ!!!</div>
			<div>
				<table border="0">
					<tr>
						<td>
							<b>ђҐ¬®­в ¦ҐбвЄЁ ¤ЁбЄ®ў в®«мЄ® г ­ б</b>
							<p>Њл ®Є §лў Ґ¬ гб«гЈЁ Ї® аҐ¬®­вг ¦ҐбвЄЁе ¤ЁбЄ®ў ўбҐе Ё§ўҐбв­ле ¬ а®Є</p>
						</td>
					</tr>
				</table>
			</div>
...
<img><xsl:attribute name="src">/image/0000058-windmill-8-140.jpg</xsl:attribute>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000059-windmill-4-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000051-windmill-5-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000052-windmill-6-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000053-windmill-7-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000054-windmill-9-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000055-windmill-10-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>

<xsl:template match="PageImage8"><div class="frame"><div class="label"><xsl:text disable-output-escaping="yes">&amp;</xsl:text>nbsp;</div>
<div class="content" align="right">
<img><xsl:attribute name="src">/image/0000056-windmill-11-140.jpg</xsl:attribute>
<xsl:attribute name="border">0</xsl:attribute><xsl:attribute name="title">Wind mill</xsl:attribute></img>
</div></div></xsl:template>
...
<xsl:call-template name="nbsp-ref"/>
<xsl:call-template name="nbsp-ref"/>
<a href="{UrlToFullNewsItem}&amp;mill.template=me.askmore-dynamic&amp;mill.xmlroot=XmlNewsItem" class="newsNext">
...
<xsl:template match="NewsItemPara">
	...
	<xsl:template match="JobBlock">
		<div class="frame">
			<div class="label">ЋвЄалвлҐ ў Є ­бЁЁ</div>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th class="jobHead">¤ в </th>
					<td width="10">
						<xsl:call-template name="nbsp-ref"/>
					</td>
					<th width="80%" class="jobHead">ў Є ­бЁп</th>
				</tr>
