...
<table width="95%" align="center" border="0" cellspacing="1" cellpadding="5">
	<tr>
		<td>
			<b><IMG SRC="/forum/img/lb_icon.gif" WIDTH="16" HEIGHT="16" BORDER=0 valign="middle">&nbsp;<a href="<c:out value='${genericBean.forumHomeUrl}'/>"><c:out value="${genericBean.forumName}"/></A>&nbsp;&gt;&nbsp;View Profile</b>
		</td>
	</tr>
</table>
<BR>
...
<table width="95%" align="center" border="0" cellspacing="1" cellpadding="5" class="forum-th">
 ...
 <%=StringTools.encodeXml(userBean.getU_name())%></td>
				...
				<tr>
					...
					<td bgcolor="#F3F3F3"><img src="/forum/img/avatars/<%=userBean.getU_avatar_id()%>.gif" width=36 height=36 border="0"></td>
				</tr>
				<tr>
