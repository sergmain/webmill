...
public class WebmillPortletRequestV2 extends ServletRequestWrapper implements HttpServletRequest {
    private final static Logger log = Logger.getLogger( WebmillPortletRequestV2.class );
...
*/
    ...
    protected void prepareRequest(final Map parameters, final PortalRequestInstance portalRequestInstance, final Map renderParameters, Map portletAttributes) {
        ...
        this.setAttribute( PortalConstants.PORTAL_USER_AGENT_ATTRIBUTE, Header.getUserAgent(httpRequest) );
        ...
        this.setAttribute( PortalConstants.PORTAL_QUERY_METHOD_ATTRIBUTE, httpRequest.getMethod() );
        this.setAttribute( PortalConstants.PORTAL_URL_RESOURCE_ATTRIBUTE, portalRequestInstance.getUrlResource() );
        this.setAttribute( PortalConstants.PORTAL_COOKIE_MANAGER_ATTRIBUTE, portalRequestInstance.getCookieManager() );
    }
}
