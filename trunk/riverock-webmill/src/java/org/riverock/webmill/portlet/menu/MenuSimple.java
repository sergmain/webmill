...
import org.riverock.webmill.schema.types.MenuSimpleType;
    ...
    public PortletResultContent getInstanceByCode( final String portletCode_ ) throws PortletException {
        ...
        try {
            ...
            ContextFactory.DefaultCtx defaultCtx =
                (ContextFactory.DefaultCtx)renderRequest.getAttribute(ContainerConstants.PORTAL_DEFAULT_CTX_ATTRIBUTE);
...
//                portletUrl.setParameter();
                ...
                if (item.getUrl()==null)
                    m.setModuleUrl(
                        renderResponse.encodeURL(PortletService.pageid(renderRequest)+'/'+renderRequest.getLocale().toString() + '/' + item.getId())
                    );
                else
                    m.setModuleUrl(
                        renderResponse.encodeURL(PortletService.page(renderRequest)+'/'+renderRequest.getLocale().toString() + '/' + item.getUrl())
                    );
            }
