...

{
    ...
    public static int indexOf( byte bytes[], byte searchByte)
    ...
    public static String writeToFile(String full_file_name, byte bytes[])
    ...
    public static boolean deleteFile(File file_)
