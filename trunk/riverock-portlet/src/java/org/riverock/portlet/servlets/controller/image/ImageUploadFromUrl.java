...
//                String indexPage = CtxInstance.url(renderRequest_, response, ctxInstance.page, "mill.image.index");

                if(cat.isDebugEnabled())
                    cat.debug("urlString - " + renderRequest.getParameter("url_download"));
...
//                    return;
                ...
                if(cat.isDebugEnabled())
                    cat.debug("id_main - "+PortletTools.getLong(renderRequest, "id_main"));
...
//                    return;
...

                {
                    ...
                    out.write(
                            ...
                            "<br>" +
                            "<p><a href=\"" + CtxInstance.url("mill.image.index") + "\">«агрузить данные повторно</a></p><br>" +
                            "<p><a href=\"" + CtxInstance.url(Constants.CTX_TYPE_INDEX) + "\">Ќа главную страницу</a></p>"
                    );
                }
            }
            catch (Exception e)
