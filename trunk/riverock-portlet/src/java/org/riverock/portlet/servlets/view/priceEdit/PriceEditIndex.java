...
public class PriceEditIndex extends HttpServlet
{
    private static Logger log = Logger.getLogger(PriceEditIndex.class);
...
//                (CtxInstance)request_.getSession().getAttribute( org.riverock.webmill.main.Constants.PORTLET_REQUEST_SESSION );
            ...
            if ( auth_==null )
            {
                ...
                if( auth_.isUserInRole("webmill.edit_price_list") )
                {
                    ...
                    try
                    {
                        ...
                        out.write(
                                ...
                                "<th class=\"memberArea\">" + CtxInstance.getStringManager( renderRequest.getLocale() ).getStr("index.jsp.action") + "</th>" +
                                "</tr>"
                        );
              ...
              out.write(CtxInstance.getStringManager( renderRequest.getLocale() ).getStr("button.next"));
              ...
              out.write("</table>\r\n            ");
                ...
                {
                    out.write( CtxInstance.getStringManager( renderRequest.getLocale() ).getStr("access_denied"));
                }
        }
        catch (Exception e)
        {
