 ...
 */
public class PriceRelateUserOrder_fr_FR extends CustomXmlResourceBundle {
    private final static Logger log = Logger.getLogger( PriceRelateUserOrder_fr_FR.class );
