...
{
    private final static Logger log = Logger.getLogger(FirmDelete.class);
            ...
            throws IOException, ServletException
    {
        ...
        try {
            ...
            if( auth_.isUserInRole("webmill.firm_delete") )
            {
              ...
              out.write("\r\n");
              out.write("<BR>\r\n");
              out.write("<FORM ACTION=\""+PortletTools.url("mill.firm.commit_del_firm", renderRequest, renderResponse ) );
