        ...
        try {
            ...
            if ( auth_.isUserInRole("webmill.firm_select") ) {
                 ...
                 out.write(
                         ...
                         "<p><a href=\""+
                         PortletTools.url("mill.firm.add_firm", renderRequest, renderResponse )+
                         "\">"+PortletTools.getStringManager( renderRequest.getLocale() ).getStr("button.add")+"</a></p>"+
                    ...
                    while ( rs.next() )
                    {
                        ...
                        out.write(
                                "<input type=\"button\" value=\""+PortletTools.getStringManager( renderRequest.getLocale() ).getStr("button.change")+"\" onclick=\"location.href='"+
                                PortletTools.url("mill.firm.ch_firm", renderRequest, renderResponse ) + '&'+
                                "id_firm="+id_firm +
                                "';\">"+
                                "<input type=\"button\" value=\""+PortletTools.getStringManager( renderRequest.getLocale() ).getStr("button.delete")+"\" onclick=\"location.href='"+
                                PortletTools.url("mill.firm.del_firm", renderRequest, renderResponse ) + '&'+
                                "id_firm="+id_firm+
                                "';\">"+
                                "</td>"+
                                "</tr>"
                ...
                out.write(
                        "<p><a href=\""+ index_page +"\">"+PortletTools.getStringManager( renderRequest.getLocale() ).getStr("page.main.3")+"</a></p>"+
                        "</td>"+
                        "</tr>"+
                        "</table>"
                );
