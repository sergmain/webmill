        ...
        <h:panelGrid columns="2">
            ...
            <h:panelGrid columns="1" rendered="#{isUserInRole['webmill.portal-manager,webmill.site-manager,webmill.menu']}">
                ...
                <h:panelGroup id="select-template-group">
                    <h:selectOneMenu id="select-one-template" value="#{menuSessionBean.templateId}"
                ...
                <h:panelGroup id="operation-menu-catalog-edit-panel">
                    <h:commandButton id="menu-catalog-change-template-process-action" action="#{menuCatalogAction.processChangeTemplateForCatalogLanguageAction}"
                                     value="#{msg['process_change_template_menu_catalog_action']}"
                                     styleClass="menu-button-action"
                        >
                    </h:commandButton>
                    <f:verbatim>&nbsp;&nbsp;&nbsp;&nbsp;</f:verbatim>
                    <h:commandButton id="menu-catalog-change-template-cancel-action" action="#{menuCatalogAction.cancelChangeTemplateForCatalogLanguageAction}"
                                     value="#{msg['cancel_change_template_menu_catalog_action']}"
                                     styleClass="menu-button-action"
                                     immediate="true"
                        >
                    </h:commandButton>
