				...
				<table border="0">
					...
					<tr>
						...
						<td>
							...
							<b>іемонт жестки дисков только у нас</b>

							<p>іv оказvваем услуги по ремонту жестких дисков всех известнvх марок</p>
...
<img><xsl:attribute name="src">/image/0000035-windmill-3.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000036-windmill-4.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000037-windmill-5.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000041-windmill-8.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000040-windmill-7.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000042-windmill-9.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000043-windmill-10.jpg</xsl:attribute>
...
<img><xsl:attribute name="src">/image/0000044-windmill-11.jpg</xsl:attribute>
...
<a href="{UrlToFullNewsItem}&amp;mill.template=me.askmore-dynamic" class="newsNext">
	...
	<xsl:template match="JobBlock">
		...
		<div class="frame">
			...
			<div class="label">+ткрvтvе вакансии</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<th width="80%" class="jobHead">ваканси </th>
...
<!--
			...
			<th class="priceData" width="85%">
				...
				<img src="/mill/images/up.gif" alt="sort"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
			...
			<th class="priceData" width="10%">
				...
				<img src="/mill/images/down.gif" alt="sort"/><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text>
