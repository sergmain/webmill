...
public class InsertWmForumUserItem 
{
    ...
    public static long process(org.riverock.generic.db.DatabaseAdapter db_, WmForumUserItemType item, String sql_)  throws org.riverock.forum.exception.PersistenceException     {
