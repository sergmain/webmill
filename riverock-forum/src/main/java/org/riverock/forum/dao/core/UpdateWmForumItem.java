...
public class UpdateWmForumItem 
{
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UpdateWmForumItem.class);

     public UpdateWmForumItem(){}

     public static long process(org.riverock.generic.db.Database db_, WmForumItemType item)  throws org.riverock.forum.exception.PersistenceException      {
         ...
         try
         {
             ...
             ps.setLong(1, item.getSiteId() );
             ps.setString(2, item.getForumName() );
             ps.setInt(3, item.getIsUseLocale()?1:0 );
             ps.setInt(4, item.getIsDeleted()?1:0 );

             // prepare PK
             ps.setLong(5, item.getForumId() );
