...
public class InsertWmForumCategoryItem 
{
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(InsertWmForumCategoryItem.class);
    ...
    public static long process(org.riverock.generic.db.Database db_, WmForumCategoryItemType item, String sql_)  throws org.riverock.forum.exception.PersistenceException     {
        ...
        try {
            ps = db_.prepareStatement(sql_);
             ...
             ps.setLong(2, item.getForumId() );
             ps.setString(3, item.getForumCategoryName() );
