...
<f:loadBundle basename="org.riverock.commerce.resource.Shop" var="msg"/>
 ...
 <h:panelGrid columns="2" border="0">
     ...
     <h:panelGroup>
         <t:graphicImage value="/images/yes.gif" rendered="#{shopSessionBean.shopExtendedBean.shop.closed}" border="0"/>
         <t:graphicImage value="/images/no.gif" rendered="#{!shopSessionBean.shopExtendedBean.shop.closed}" border="0"/>
     </h:panelGroup>
