...
public class ServiceRefHandlerType {
    ...
    protected org.riverock.webmill.container.definition.web_xml_v2_4.String handlerName;
    ...
    protected List<org.riverock.webmill.container.definition.web_xml_v2_4.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<org.riverock.webmill.container.definition.web_xml_v2_4.String> portName;
    @XmlAttribute
     ...
     *     
     */
    public org.riverock.webmill.container.definition.web_xml_v2_4.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(org.riverock.webmill.container.definition.web_xml_v2_4.String value) {
     ...
     * 
     */
    public List<org.riverock.webmill.container.definition.web_xml_v2_4.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<org.riverock.webmill.container.definition.web_xml_v2_4.String>();
        }
     ...
     * 
     */
    public List<org.riverock.webmill.container.definition.web_xml_v2_4.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<org.riverock.webmill.container.definition.web_xml_v2_4.String>();
        }
