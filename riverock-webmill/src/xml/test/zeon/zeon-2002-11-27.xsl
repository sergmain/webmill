...
<table border="0"><tr><td>
   ...
   <b>Ремонт жестких дисков только у нас</b>
...
<xsl:text disable-output-escaping="yes">&lt;/body&gt;&lt;/html&gt;
	...
	<xsl:template match="HeaderStart">
		...
		<head>
			...
			<link rel="stylesheet" href="/mill/share/css.jsp"/>

<title>Zeon site</title>

		</head>

		<xsl:text disable-output-escaping="yes">&lt;body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#FFFFFF" text="#000000"></xsl:text>
