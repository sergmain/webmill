...
public class ContextConfig
{
    ...
    private static Logger cat = Logger.getLogger( "org.riverock.webmill.port.ContextConfig" );
            ...
            throws Exception
    {
        ...
        isXml = (RsetTools.getInt(rs, "IS_XML", new Integer(0) ).intValue() == 1?true:false);
