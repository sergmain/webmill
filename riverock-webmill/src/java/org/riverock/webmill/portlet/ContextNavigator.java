...

{
     ...
     * ќпредел€ем тип контекста. если определить не удаетс€,
...
// ≈сли не указан ни ID контекста ни его тип, обрабатываем как index_page
...
/*
                                    ...
                                    // Todo здесь кака€ то хуйн€ - по идее этот код не должен выполн€тьс€ никогда
...

    {
...

        {
...

            {
                ...
                // определ€ем текущий тип контекста
