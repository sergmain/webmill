...

{
    ...
    private static Logger log = Logger.getLogger( "org.riverock.webmill.a3.audit.RequestStatisticFilter" );
    ...
    private static HashMap userAgent = null;

    private static HashMap url = null;
...

                            {
...

                                {
...

                                    {
                                        ...
                                        userAgent = new HashMap( userAgentList.getSiteAccessUserAgentCount()+15 );
...

                            {
...

                                {
...

                                    {
                                        ...
                                        url = new HashMap( urlList.getSiteAccessUrlCount() );

                                        for ( int i = 0; i<urlList.getSiteAccessUrlCount(); i++ )

                                        {

                                            SiteAccessUrlItemType urlItem =

                                                    urlList.getSiteAccessUrl( i );
