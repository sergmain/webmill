...
//        checkClass("org.riverock.multipart.MaybeUploadRequestWrapper");

        checkClass("org.exolab.castor.xml.Marshaller");
...
/*
...

        {
            ...
            URL url = context.getResource("/WEB-INF/mill/portlet/");

            XmlTools.writeToFile(url, GenericConfig.getGenericDebugDir() + "resource-url.xml");



            Object obj = url.getContent();

            System.out.println("instanse of getContent() is " + obj.getClass().getName());

            XmlTools.writeToFile(obj, GenericConfig.getGenericDebugDir() + "resource-url-object.xml");

//            org.apache.naming.resources.FileDirContext obj1;
