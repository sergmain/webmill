...

    {
...

        {
            ...
            if (log.isDebugEnabled())
                ...
                log.debug("Get object from cache, class "+cache.getClassName()+", result object "+obj);
...

        {
            ...
            log.error("Exception in CacheFactory.getInstanceNew(DatabaseAdapter db__, Long id__)", e);
...

        {
            ...
            log.error("Error in CacheFactory.getInstanceNew(DatabaseAdapter db__, Long id__)", err);
