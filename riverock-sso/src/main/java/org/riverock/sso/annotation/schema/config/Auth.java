 ...
 *       &lt;sequence>
 *         &lt;element name="AuthProvider" type="{}AuthProvider" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Auth {
    ...
    @XmlElement(name = "AuthProvider", required = true)
    protected List<AuthProvider> authProvider;
     ...
     * This is why there is not a <CODE>set</CODE> method for the authProvider property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAuthProvider().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<AuthProvider> getAuthProvider() {
        if (authProvider == null) {
            authProvider = new ArrayList<AuthProvider>();
        }
