...
//            (config.getIsUseCache()?" extends org.riverock.generic.main.CacheFactory ":"") +
    ...
    private static String getEndOfClassUID(
...
//            throw new Exception("Table '"+table.getName()+"' not have primary key");
...

        {
            ...
            String className = "Get"+base+"With"+

                StringTools.capitalizeString( key.getFkColumnName() )+"List";



            String classNameItem = StringTools.capitalizeString( table.getName() )+
...
//        MainTools.writeToFile( d+className+".java", s.getBytes());
...

    {
        ...
        return
            ...
            ?"                     item.set"+StringTools.capitalizeString(field.getName())+"( new Boolean(tempBoolean==1?true:false) );\n"
            ...
            ?"                     item.set"+StringTools.capitalizeString(field.getName())+"( new Boolean(false) );\n"
...

    {
        ...
        return config.getDefaultNamespacePrefix()+':'+type;
...
//        cType.setContentType(ContentType.mixed);
    ...
    private static void createDeleteListForFk( DbTableType table )
...

    {
...

        {
            ...
            String className = "Delete"+base+"With"+

                StringTools.capitalizeString( key.getFkColumnName() );
...
//            throw new Exception("Table '"+table.getName()+"' not have primary key");
        ...
        String className = "Delete"+base+"With"+
            ...
            StringTools.capitalizeString( column.getColumnName() );
...
//        MainTools.writeToFile( d+className+".java", s.getBytes());
    ...
    private static void createInsertClassForPk(DbTableType table)
