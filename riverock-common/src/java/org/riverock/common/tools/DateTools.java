...

{
    ...
    public static java.util.Date getDateWithMask(String date, String mask)
...
//        String currDate = getStringDate(c_, mask, Locale.ENGLISH);
    ...
    public static String getCurrentDate(String mask, Locale loc, TimeZone timeZone)
    ...
    public static String getCurrentDate(String mask, TimeZone timeZone)
