...
/**
 * Class FromItemTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class FromItemTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FromItemTypeDescriptor() {
        super();
        xmlName = "FromItemType";
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                FromItemType target = (FromItemType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- org.riverock.schema.sql.FromItemTypeDescriptor()
    ...
    {
        return org.riverock.schema.sql.FromItemType.class;
